    ...
    <div class="relative flex flex-col justify-center min-h-screen overflow-hidden">
        <div
            ...
            <div class="text-center p-6 bg-slate-900 rounded-t">
                <a href='/'><img src="{{ URL::asset('assets/images/logo-sm.png') }}"  alt="" class="w-14 h-14 mx-auto mb-2"></a>
                <h3 class="font-semibold text-white text-xl mb-1">Reset Password For DevMe</h3>
                <p class="text-xs text-slate-400">Enter your Email and instructions will be sent to you!</p>
            </div>

            <form class="p-6" method="POST" action="{{ route('password.store') }}">
                @csrf
                <!-- Password Reset Token -->
                <input type="hidden" name="token" value="{{ $request->route('token') }}">
                <div>
